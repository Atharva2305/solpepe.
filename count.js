...
function initCountdown() {
    $(".countdown:not(.countdown-inited)").each(function() {
        $(this).addClass('countdown-inited').countdown($(this).attr('data-due-date'), function(event) {
            ...
            $(this).html(event.strftime(['<div class="row">', '<div class="col-3">', '<div class="number-wrap">', '<span class="number display-2" style="font-size:40px;"><b>%D</b></span><br>', '<span mbr-text class="period display-7" style="font-size:12px;">', $days, '</span>', '<span class="dot">:</span>', '</div>', '</div>', '<div class="col-3">', '<div class="number-wrap">', '<span class="number display-2" style="font-size:40px;"><b>%H</b></span><br>', '<span mbr-text class="period display-7" style="font-size:12px;">', $hours, '</span>', '<span class="dot">:</span>', '</div>', '</div>', '<div class="col-3">', '<div class="number-wrap">', '<span class="number display-2" style="font-size:40px;"><b>%M</b></span><br>', '<span mbr-text class="period display-7" style="font-size:12px;">', $minutes, '</span>', '<span class="dot">:</span>', '</div>', '</div>', '<div class="col-3">', '<div class="number-wrap">', '<span class="number display-2" style="font-size:40px;"><b>%S</b></span><br>', '<span mbr-text class="period display-7" style="font-size:12px;">', $seconds, '</span>', '</div>', '</div>', '</div>'].join('')));
        });
    });
